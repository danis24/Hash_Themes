...
$layout = (hash_wow_sh_set($settings, 'archive_page_layout')) ? hash_wow_sh_set($settings, 'archive_page_layout') : '';
$page_sidebar = hash_wow_sh_set($settings, 'archive_page_sidebar', 'blog-sidebar');
if(hash_wow_sh_set($settings, 'archive_page_title')) :
	$title = hash_wow_sh_set($settings, 'archive_page_title');
elseif( is_day() ) :
	$title = sprintf( esc_html__('Daily Archives: %s', 'hash' ), get_the_date() );
elseif( is_month() ) :
	$title = sprintf( esc_html__('Monthly Archives: %s', 'hash' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'hash' ) ) );
elseif ( is_year() ) :
	$title = sprintf( esc_html__( 'Yearly Archives: %s', 'hash' ), get_the_date( _x( 'Y', 'yearly archives date format', 'hash' ) ) );
else :
	$title = esc_html__('Archives', 'hash' );
endif;		
