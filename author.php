...
$layout = (hash_wow_sh_set($settings, 'author_page_layout')) ? hash_wow_sh_set($settings, 'author_page_layout') : '';
$page_sidebar = hash_wow_sh_set($settings, 'author_page_sidebar', 'blog-sidebar');
if(hash_wow_sh_set($settings, 'author_page_title')) :
	$title = hash_wow_sh_set($settings, 'author_page_title');
else:
	$title = sprintf( esc_html__( 'All posts by %s', 'hash' ), get_the_author() );
