...
$layout = (hash_wow_sh_set($settings, 'tag_page_layout')) ? hash_wow_sh_set($settings, 'tag_page_layout') : '';
$page_sidebar = hash_wow_sh_set($settings, 'tag_page_sidebar', 'blog-sidebar');
